 ...
 * @return Zero if equal, non-zero if not.
 */
extern int strncmp(const char *dest, const char *src, size_t count);
 ...
 * @return Zero if equal, non-zero if not.
 */
extern int strncasecmp(const char *dest, const char *src, size_t count);
 ...
 * @return Number of bytes copied.
 */
extern int strncpy(char *dest, const char *src, size_t sz);
 ...
 */
extern char * strncat(char *dest, const char *src, size_t siz);
